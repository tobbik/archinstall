...
" Syntax highlighting
hi Keyword		ctermfg=111		cterm=none		guifg=#88b8f6	gui=bold
...
hi Identifier	ctermfg=192		cterm=bold		guifg=#cae982	gui=bold
hi Type			ctermfg=186		cterm=bold		guifg=#d4d987	gui=bold
